...
public class CustomerFrame extends javax.swing.JDialog {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            Customer customerToEdit = manageCustomer.searchCustomerByID(customerIDField.getText());

            if (customerToEdit != null) {

                customerToEdit.setCustomerName(fullNameField.getText());
                customerToEdit.setPhoneNumber(Integer.parseInt(phoneNumberField.getText()));
